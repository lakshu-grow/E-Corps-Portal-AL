...
<%
    ...
    // ✅ If first time (no data), auto redirect to servlet
    if (articles == null) {
...
<head>
    <meta charset="UTF-8">
    <title>India Defence News</title>
...
<body>
    ...
    <div class="navbar">
        ...
        <a href="Staff.html" class="dashboard-btn">🏠 Back to Dashboard</a>
    </div>

    <!-- ✅ Page Title -->
    <h2 class="page-title">🇮🇳 India Defence News</h2>
